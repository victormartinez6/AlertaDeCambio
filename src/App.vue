            ...
            <template v-else>
              <div class="hidden md:flex md:items-center">
                ...
                <router-link
                  to="/agente/widgets"
                  class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:text-primary-600 hover:bg-gray-50 rounded-lg transition-colors"
                  :class="{ 'bg-gray-50 text-primary-600 font-semibold': $route.path.includes('/agente/widgets') }"
                >
                  <WindowIcon class="h-5 w-5 mr-1.5" />
                  Widgets
                </router-link>
        ...
        <div v-show="mobileMenuOpen" class="md:hidden border-t border-gray-200">
          <div class="px-2 py-3 space-y-1">
            ...
            <RouterLink
              to="/agente/widgets"
              class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50"
              :class="{ 'bg-gray-50 text-primary-600': $route.path.includes('/agente/widgets') }"
              @click="mobileMenuOpen = false"
            >
              <div class="flex items-center">
...
import { UserIcon, XMarkIcon, LockClosedIcon, ArrowPathIcon, HomeIcon, BellAlertIcon, PlusIcon, ArrowRightOnRectangleIcon, Cog6ToothIcon, BoltIcon, Bars3Icon, WindowIcon } from '@heroicons/vue/24/outline'
