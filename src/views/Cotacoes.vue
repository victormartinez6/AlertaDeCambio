...
onMounted(() => {
  ...
  // Inicializar todos os cards como abertos e carregar histórico
  Object.values(cotacoes.value).forEach(async (moeda: any) => {
    await store.buscarHistoricoCotacao(moeda.code)
    expandedCards.value[moeda.code] = true
  })
