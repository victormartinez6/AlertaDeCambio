            ...
            <table class="min-w-full divide-y divide-gray-300">
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="alerta in alertas" :key="alerta.id">
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                    <span :class="[
                      statusClasses[alerta.ativo ? 'ativo' : 'expirado'],
                      'inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset'
                    ]">
                      {{ statusTexto[alerta.ativo ? 'ativo' : 'expirado'] }}
                    </span>
                  </td>
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
...
const statusClasses = {
  ...
  expirado: 'text-gray-600 bg-gray-50 ring-gray-500/10',
  atingido: 'text-blue-700 bg-blue-50 ring-blue-700/10'
}
